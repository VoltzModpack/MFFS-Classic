...
public class Config {
	...
	public Config() {
		...
		configuration.save();
		FMLLog.info("[Modstats] Config loaded. allowUpdates: %b,  betaNotification: %b, strict: %b", new Object[]{this.allowUpdates, this.betaNotifications, this.forCurrentMinecraftVersion});
	}
}
