					...
					while (true) {
						...
						do {
							do {
								...
								} while (!entityHit.canBeCollidedWith());
							} while (entityHit.boundingBox == null);

							float border = entityHit.getCollisionBorderSize();
							aabb = entityHit.boundingBox.expand((double) border, (double) border, (double) border);
							hitMOP = aabb.calculateIntercept(startingPosition, reachPoint);
						} while (hitMOP == null);
