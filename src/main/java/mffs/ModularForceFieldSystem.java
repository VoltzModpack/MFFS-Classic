...
public class ModularForceFieldSystem {
	...
	public void postInit(FMLPostInitializationEvent evt) {
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemFocusMatix, 9), new Object[]{"RMR", "MDM", "RMR", 'M', "ingotSteel", 'D', Item.diamond, 'R', Item.redstone}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(blockFortronCapacitor), new Object[]{"MFM", "FCF", "MFM", 'D', Item.diamond, 'C', UniversalRecipes.BATTERY, 'F', itemFocusMatix, 'M', "ingotSteel"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(blockForceFieldProjector), new Object[]{" D ", "FFF", "MCM", 'D', Item.diamond, 'C', UniversalRecipes.BATTERY, 'F', itemFocusMatix, 'M', "ingotSteel"}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(blockInterdictionMatrix), new Object[]{"SSS", "FFF", "FEF", 'S', itemModuleShock, 'E', Block.enderChest, 'F', itemFocusMatix}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemCardBlank), new Object[]{"PPP", "PMP", "PPP", 'P', Item.paper, 'M', "ingotSteel"}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemCardID), new Object[]{"RBR", 'B', itemCardBlank, 'R', Item.redstone}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleSpeed, 2), new Object[]{"FFF", "RRR", "FFF", 'F', itemFocusMatix, 'R', Item.redstone}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleSponge), new Object[]{"BBB", "BFB", "BBB", 'F', itemFocusMatix, 'B', Item.bucketWater}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleGlow, 4), new Object[]{"GGG", "GFG", "GGG", 'F', itemFocusMatix, 'G', Block.glowStone}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleStablize), new Object[]{"FDF", "PSA", "FDF", 'F', itemFocusMatix, 'P', Item.pickaxeDiamond, 'S', Item.shovelDiamond, 'A', Item.axeDiamond, 'D', Item.diamond}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleCollection), new Object[]{"F F", " H ", "F F", 'F', itemFocusMatix, 'H', Block.hopperBlock}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleInvert), new Object[]{"L", "F", "L", 'F', itemFocusMatix, 'L', Block.blockLapis}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleSilence), new Object[]{" N ", "NFN", " N ", 'F', itemFocusMatix, 'N', Block.music}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleAntiHostile), new Object[]{" R ", "GFB", " S ", 'F', itemFocusMatix, 'G', Item.gunpowder, 'R', Item.rottenFlesh, 'B', Item.bone, 'S', Item.ghastTear}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleAntiFriendly), new Object[]{" R ", "GFB", " S ", 'F', itemFocusMatix, 'G', Item.porkCooked, 'R', new ItemStack(Block.cloth, 1, 32767), 'B', Item.leather, 'S', Item.slimeBall}));
		...
		RecipeHelper.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleConfiscate), new Object[]{"PEP", "EFE", "PEP", 'F', itemFocusMatix, 'E', Item.eyeOfEnder, 'P', Item.enderPearl}), Settings.CONFIGURATION, true);
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleWarn), new Object[]{"NFN", 'F', itemFocusMatix, 'N', Block.music}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleBlockAccess), new Object[]{" C ", "BFB", " C ", 'F', itemFocusMatix, 'B', Block.blockIron, 'C', Block.chest}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemModuleBlockAlter), new Object[]{" G ", "GFG", " G ", 'F', itemModuleBlockAccess, 'G', Block.blockGold}));
